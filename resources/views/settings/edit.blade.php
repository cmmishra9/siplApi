...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-5">
                {{ Form::open(['route' => 'settings.update', 'files'=>true])}}
                <div class="card-header bg-transparent"><h4 class="mb-0">User Settings</h4></div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="card mb-5">
                {{ Form::open(['route' => 'settings.update', 'files'=>true])}}
                <div class="card-header bg-transparent"><h4 class="mb-0">Main Website Settings</h4></div>
                <div class="card-body">
                    <div class="col-md-12">
                        {{Form::label('website_title', 'Website Title', ['class' => 'form-control-label'])}}
                        {{ Form::text('website_title', setting('website_title'), ['class'=>"form-control", 'placeholder'=>"Website Title"])}}
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <div class="form-group">
                                {{Form::label('website_kw', 'Website Keywords', ['class' => 'form-control-label'])}}
                                {!! Form::textarea('website_kw', setting('website_kw'), ['class'=>"form-control", 'placeholder'=>"Website Keywords"]) !!}
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('website_desc', 'WebSite Descriptions', ['class' => 'form-control-label']) }}
                                {{ Form::textarea('website_desc', setting('website_desc', null), [ 'class'=> 'form-control', 'placeholder' => 'website Descriptions']) }}
                            </div>
                        </div>
